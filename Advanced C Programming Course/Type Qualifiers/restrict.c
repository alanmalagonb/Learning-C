/*
    ...
    -without the restrict keyword used, the compiler is free to look for computational shortcuts

    -if a programmer uses restrict keyword and violete the above condition, result is undefined behavior
